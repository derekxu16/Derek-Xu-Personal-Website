...
export default function Resume() {
  return (
    <div className='fullscreen' style={{ display: 'flex', justifyContent: 'center' }}>
      <HomeButton />
      <TileContainer>
        <DimTile name='Education' icon='graduation' color='#e4b429' message="I'm currently in the middle of my 3B term of SE at Waterloo. Prior to this, I completed the IB program at Colonel By SS." />
